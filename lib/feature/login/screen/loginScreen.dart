                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        child: Text("Forgot Password?",
                            style: TextStyle(fontSize: width*0.03,fontWeight: FontWeight.bold,color: Colors.orangeAccent)))
                  ],
                ),
                SizedBox(height: height*0.08,),
                Consumer(
                  builder: (context,ref,child) {
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        TextStyle(fontSize: width*0.05,color: Colors.white,fontWeight: FontWeight.bold),)),
